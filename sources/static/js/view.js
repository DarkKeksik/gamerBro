$( document ).ready(function() {
  ...
  $("body").on("click", "#minimizeChat", function() {
    ...
    $( this ).parents(".modalChat").slideUp(function() {
      if (modalChatIsShow) $(".popupB").animate({ bottom: '25'}, "slow");
    });
  });
  ...
  $("body").on("click", ".menu__item, .nextSection", function() {
    ...
    if (href == "about") {
      ...
      $('html').animate({scrollTop: 908},500);
    } else if (href == "review") {
  ...
  $("body").on("click", ".s-preview__game_available", function() {
    ...
    // $(`.modal .modal__select>option:contains(${gameName})`).attr('selected', 'true');
